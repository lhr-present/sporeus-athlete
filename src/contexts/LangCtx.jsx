...
export const LABELS = {
  en: {
    ...
    weightTitle: 'WEIGHT & HYDRATION', weightL: 'MORNING WEIGHT (kg)', weightSaveBtn: 'LOG WEIGHT',
  ...
  tr: {
    ...
    weightTitle: 'KİLO & HİDRASYON', weightL: 'SABAH KILOSU (kg)', weightSaveBtn: 'KİLO KAYDET',
