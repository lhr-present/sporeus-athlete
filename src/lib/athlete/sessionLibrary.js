...
const RUN_SESSIONS = {
  ...
  RACE_DAY:           { type: 'RACE DAY',                   tr: 'YARIŞ GÜNÜ',                  durationMin: 60,  paceKey: null, zone: 5, rpeLow: 9, rpeHigh: 10, hrPctLow: null, hrPctHigh: null, tss: 70, structure: 'WU 10–15min easy + 4–6 race-pace strides. MAIN: Execute your race plan — first 4K at goal pace, hold through 8K, empty the tank in final 2K. Negative split target: first 5K 2–3s/km slower than goal pace.', structureTr: 'Isınma 10–15dk kolay + 4–6 yarış temposu hız açma. ANA: Yarış planını uygula — ilk 4K hedef tempoda, 8K\'ya kadar tut, son 2K\'da tankı boşalt. Negatif split hedefi: ilk 5K hedeften 2–3s/km yavaş.' },
}
