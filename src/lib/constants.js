...
export const DASH_CARD_DEFS = [
  ...
  //    NOTE i18n gap: the customize panel renders `card.label` raw (English only),
  //    same as the 20 entries above. Not fixed here; tracked separately.
  { id:'missionHeadline',            label:'Mission Headline'              },
  { id:'eliteProgram',               label:'Elite Program'                 },
  { id:'fieldTestHistory',           label:'Field Test History'            },
  { id:'todayProgrammedSession',     label:'Today’s Programmed Session'},
  { id:'todayStrip',                 label:'Today Strip'                   },
  { id:'eliteMetrics',               label:'Elite Metrics Strip'           },
  { id:'dailyBriefing',              label:'Daily Briefing'                },
  { id:'nutritionTiming',            label:'Nutrition Timing'              },
  { id:'todayReadiness',             label:'Today Readiness'               },
  { id:'raceGoalAnalyzer',           label:'Race Goal Analyzer'            },
  { id:'programSelector',            label:'Program Selector'              },
  { id:'coachGate',                  label:'Coach Gate'                    },
  { id:'trainingBridge',             label:'Training Bridge'               },
  { id:'raceGoalDash',               label:'Race Goal Dash'                },
  { id:'vdotProgress',               label:'VDOT Progress'                 },
  { id:'milestones',                 label:'Milestones'                    },
  { id:'backupReminder',             label:'Backup Reminder'               },
  { id:'weeklyRetro',                label:'Weekly Retro'                  },
  { id:'phaseAnalytics',             label:'Phase Analytics'               },
  { id:'raceReadiness',              label:'Race Readiness'                },
  { id:'raceWeekProtocol',           label:'Race Week Protocol'            },
  { id:'eliteRaceWeek',              label:'Elite Race Week'               },
  { id:'raceDayFuelingTimeline',     label:'Race Day Fueling Timeline'     },
  { id:'raceMentalRehearsal',        label:'Race Mental Rehearsal'         },
  { id:'raceEquipmentChecklist',     label:'Race Equipment Checklist'      },
  { id:'preRaceSleepBanking',        label:'Pre-Race Sleep Banking'        },
  { id:'altitudeStimulus',           label:'Altitude Stimulus'             },
  { id:'postHardSessionResponse',    label:'Post-Hard Session Response'    },
  { id:'seasonalLoadDistribution',   label:'Seasonal Load Distribution'    },
  { id:'crossSportRecoveryGap',      label:'Cross-Sport Recovery Gap'      },
  { id:'morningLogConsistency',      label:'Morning Log Consistency'       },
  { id:'weeklyGoalVariance',         label:'Weekly Goal Variance'          },
  { id:'checkInQuality',             label:'Check-In Quality'              },
  { id:'averageWeekShape',           label:'Average Week Shape'            },
  { id:'moodEnergyBalance',          label:'Mood / Energy Balance'         },
  { id:'rpeStability',               label:'RPE Stability'                 },
  { id:'stressPattern',              label:'Stress Pattern'                },
  { id:'perseverance',               label:'Perseverance'                  },
  { id:'longestSessionTrend',        label:'Longest Session Trend'         },
  { id:'weeklyVolumeIntensityRatio', label:'Volume / Intensity Ratio'      },
  { id:'sessionDensity',             label:'Session Density'               },
  { id:'sleepConsistency',           label:'Sleep Consistency'             },
  { id:'lifetimeTotals',             label:'Lifetime Totals'               },
  { id:'yearOverYear',               label:'Year Over Year'                },
  { id:'trainingAgeStage',           label:'Training Age Stage'            },
  { id:'weeklyVolumeRecord',         label:'Weekly Volume Record'          },
  { id:'raceTimeEstimator',          label:'Race Time Estimator'           },
  { id:'paceByRpe',                  label:'Pace by RPE'                   },
  { id:'volumeAcceleration',         label:'Volume Acceleration'           },
  { id:'annualTssTarget',            label:'Annual TSS Target'             },
  { id:'hrForRpe',                   label:'HR for RPE'                    },
  { id:'bedtimeConsistency',         label:'Bedtime Consistency'           },
  { id:'restingHrFitnessTrend',      label:'Resting HR Fitness Trend'      },
  { id:'energySorenessDivergence',   label:'Energy / Soreness Divergence'  },
  { id:'logStreakBreaker',           label:'Log Streak Breaker'            },
  { id:'dataCoverage',               label:'Data Coverage'                 },
  { id:'dayOfWeekAvailability',      label:'Day-of-Week Availability'      },
  { id:'perfectWeek',                label:'Perfect Week'                  },
  { id:'weeklyTssVariance',          label:'Weekly TSS Variance'           },
  { id:'longRunFrequency',           label:'Long Run Frequency'            },
  { id:'recoveryQualityStreak',      label:'Recovery Quality Streak'       },
  { id:'ctlSlope',                   label:'CTL Slope'                     },
  { id:'weeklyKmPerSport',           label:'Weekly Km per Sport'           },
  { id:'paceRange',                  label:'Pace Range'                    },
  { id:'timeOnFeet',                 label:'Time on Feet'                  },
  { id:'restDayDistribution',        label:'Rest Day Distribution'         },
  { id:'newSessionTypeIntro',        label:'New Session Type Intro'        },
  { id:'mesocycleProgression',       label:'Mesocycle Progression'         },
  { id:'volumeIntensityScissors',    label:'Volume / Intensity Scissors'   },
  { id:'longRunConsistency',         label:'Long Run Consistency'          },
  { id:'calendarHoles',              label:'Calendar Holes'                },
  { id:'backToBackLongDay',          label:'Back-to-Back Long Day'         },
  { id:'seasonAnchor',               label:'Season Anchor'                 },
  { id:'cumulativeFatigueWindows',   label:'Cumulative Fatigue Windows'    },
  { id:'weeklyEnduranceTime',        label:'Weekly Endurance Time'         },
  { id:'twoADays',                   label:'Two-a-Days'                    },
  { id:'sessionLengthDistribution',  label:'Session Length Distribution'   },
  { id:'hardEasyAdherence',          label:'Hard / Easy Adherence'         },
  { id:'peakWeekFrequency',          label:'Peak Week Frequency'           },
  { id:'zoneThreeBlackHole',         label:'Zone 3 Black Hole'             },
  { id:'hardSessionTypePattern',     label:'Hard Session Type Pattern'     },
  { id:'restDayEnergyTrend',         label:'Rest Day Energy Trend'         },
  { id:'highRpeBlock',               label:'High RPE Block'                },
  { id:'postLongRunNextDay',         label:'Post Long-Run Next Day'        },
  { id:'midweekHardDayFrequency',    label:'Midweek Hard Day Frequency'    },
  { id:'resetWeekEffect',            label:'Reset Week Effect'             },
  { id:'seasonRestartCount',         label:'Season Restart Count'          },
  { id:'dailyVolumeRange',           label:'Daily Volume Range'            },
  { id:'weeklyVolumeStreak',         label:'Weekly Volume Streak'          },
  { id:'microcycleVariety',          label:'Microcycle Variety'            },
  { id:'trainRestTrainPattern',      label:'Train-Rest-Train Pattern'      },
  { id:'overlookedSessionType',      label:'Overlooked Session Type'       },
  { id:'highRpeLowTss',              label:'High RPE / Low TSS'            },
  { id:'trainingHourBudget',         label:'Training Hour Budget'          },
  { id:'weekendLongSessionShare',    label:'Weekend Long Session Share'    },
  { id:'volumePerSessionTrend',      label:'Volume per Session Trend'      },
  { id:'alternatingWeekPattern',     label:'Alternating Week Pattern'      },
  { id:'hardWeekUnrested',           label:'Hard Week Unrested'            },
  { id:'maxTssDayPersonalRecord',    label:'Max TSS Day PR'                },
  { id:'sessionGapVariance',         label:'Session Gap Variance'          },
  { id:'trainAfterRest',             label:'Train After Rest'              },
  { id:'afterBigWeekRpe',            label:'After Big Week RPE'            },
  { id:'veryEasyShare',              label:'Very Easy Share'               },
  { id:'consecutiveDeloadCount',     label:'Consecutive Deload Count'      },
  { id:'postHardSessionSoreness',    label:'Post-Hard Session Soreness'    },
  { id:'hardDaySpacing',             label:'Hard Day Spacing'              },
  { id:'proactiveInjuryAlert',       label:'Proactive Injury Alert'        },
  { id:'loadSpikeAlert',             label:'Load Spike Alert'              },
  { id:'weeklyTssGoal',              label:'Weekly TSS Goal'               },
  { id:'weeklyReview',               label:'Weekly Review'                 },
  { id:'consistencyDepth',           label:'Consistency Depth'             },
  { id:'monthlyProgress',            label:'Monthly Progress'              },
  { id:'weekSessionType',            label:'Week Session Type'             },
  { id:'intensityBalance',           label:'Intensity Balance'             },
  { id:'allZones',                   label:'All Zones'                     },
  { id:'hrvTrend',                   label:'HRV Trend'                     },
  { id:'insightsPanel',              label:'Insights Panel'                },
  { id:'efTrend',                    label:'EF Trend'                      },
  { id:'yourPatterns',               label:'Your Patterns'                 },
  { id:'weekStory',                  label:'Week Story'                    },
  { id:'fuelGuidance',               label:'Fuel Guidance'                 },
  { id:'didYouKnow',                 label:'Did You Know'                  },
  { id:'sessionNotes',               label:'Session Notes'                 },
  { id:'cadenceTrend',               label:'Cadence Trend'                 },
  { id:'subThresholdTrend',          label:'Sub-Threshold Trend'           },
  { id:'zoneDistributor',            label:'Zone Distributor'              },
  { id:'triDashboard',               label:'Triathlon Dashboard'           },
  { id:'banisterModel',              label:'Banister Model'                },
  { id:'durability',                 label:'Durability'                    },
  { id:'normative',                  label:'Normative Comparison'          },
  { id:'weeklyReport',               label:'Weekly Report'                 },
  { id:'coachingSummaryScore',       label:'Coaching Summary Score'        },
  { id:'coachingInsightsDigest',     label:'Coaching Insights Digest'      },
  { id:'staleZones',                 label:'Stale Zones'                   },
  { id:'workoutDensity',             label:'Workout Density'               },
  { id:'sessionVariety',             label:'Session Variety'               },
  { id:'fitnessGainRate',            label:'Fitness Gain Rate'             },
  { id:'easyDayCompliance',          label:'Easy Day Compliance'           },
  { id:'trainingDistribution',       label:'Training Distribution'         },
  { id:'detrainingDetector',         label:'Detraining Detector'           },
  { id:'monotonyStrain',             label:'Monotony / Strain'             },
  { id:'vo2Gap',                     label:'VO2 Gap'                       },
  { id:'streak',                     label:'Streak'                        },
  { id:'sessionRpeDrift',            label:'Session RPE Drift'             },
  { id:'recoveryDebt',               label:'Recovery Debt'                 },
  { id:'timeInZone',                 label:'Time in Zone'                  },
  { id:'supercompensationWindow',    label:'Supercompensation Window'      },
  { id:'trainingPolarization',       label:'Training Polarization'         },
  { id:'fitnessConsistency',         label:'Fitness Consistency'           },
  { id:'recoveryAdherence',          label:'Recovery Adherence'            },
  { id:'trainingDiversity',          label:'Training Diversity'            },
  { id:'deloadCadence',              label:'Deload Cadence'                },
  { id:'seasonStats',                label:'Season Stats'                  },
  { id:'cpDecay',                    label:'CP Decay'                      },
  { id:'rowingMetrics',              label:'Rowing Metrics'                },
  { id:'rowingSplitConsistency',     label:'Rowing Split Consistency'      },
  { id:'challenge',                  label:'Challenge'                     },
  { id:'nmFreshness',                label:'Neuromuscular Freshness'       },
  { id:'polarizationCompliance',     label:'Polarization Compliance'       },
  { id:'aerobicEfficiency',          label:'Aerobic Efficiency'            },
  { id:'restqTrend',                 label:'RESTQ Trend'                   },
  { id:'injuryForecast',             label:'Injury Forecast'               },
  { id:'strainHistory',              label:'Strain History'                },
  { id:'consistencyTrend',           label:'Consistency Trend'             },
  { id:'insightFeed',                label:'Insight Feed'                  },
  { id:'recoveryProtocol',           label:'Recovery Protocol'             },
  { id:'recoveryHub',                label:'Recovery Hub'                  },
  { id:'ostrcMonitor',               label:'OSTRC Monitor'                 },
  { id:'hrvSummary',                 label:'HRV Summary'                   },
  { id:'vo2maxProgression',          label:'VO2max Progression'            },
  { id:'vo2maxPlateau',              label:'VO2max Plateau'                },
  { id:'ruleAlerts',                 label:'Rule Alerts'                   },
  { id:'cyclePlanner',               label:'Cycle Planner'                 },
  { id:'planAdherence',              label:'Plan Adherence'                },
  { id:'planScore',                  label:'Plan Score'                    },
  { id:'athleteStatusSummary',       label:'Athlete Status Summary'        },
  { id:'sleepRestingHr',             label:'Sleep / Resting HR'            },
  { id:'sleepCtlCorrelation',        label:'Sleep / CTL Correlation'       },
  { id:'sleepDebt',                  label:'Sleep Debt'                    },
  { id:'recoveryStreak',             label:'Recovery Streak'               },
  { id:'restingHrDrift',             label:'Resting HR Drift'              },
  { id:'sessionClassifierBreakdown', label:'Session Classifier Breakdown'  },
  { id:'workoutDeviation',           label:'Workout Deviation'             },
  { id:'monotonyTrend',              label:'Monotony Trend'                },
  { id:'aerobicDecouplingTrend',     label:'Aerobic Decoupling Trend'      },
  { id:'efDecoupling',               label:'EF Decoupling'                 },
  { id:'overreachWatch',             label:'Overreach Watch'               },
  { id:'ctlRampRate',                label:'CTL Ramp Rate'                 },
  { id:'weeklyVolumeRamp',           label:'Weekly Volume Ramp'            },
  { id:'weekendVolumeShare',         label:'Weekend Volume Share'          },
  { id:'timeOfDayConsistency',       label:'Time-of-Day Consistency'       },
  { id:'longSessionShare',           label:'Long Session Share'            },
  { id:'runningCadenceTrend',        label:'Running Cadence Trend'         },
  { id:'tsbFreshnessBand',           label:'TSB Freshness Band'            },
  { id:'prTimeline',                 label:'PR Timeline'                   },
  { id:'loadProjector',              label:'Load Projector'                },
  { id:'injuryPattern',              label:'Injury Pattern'                },
  { id:'vdotBenchmark',              label:'VDOT Benchmark'                },
  { id:'hrvAlert',                   label:'HRV Alert'                     },
  { id:'hrvAutonomicBalance',        label:'HRV Autonomic Balance'         },
  { id:'taperAdvisor',               label:'Taper Advisor'                 },
  { id:'taperCompliance',            label:'Taper Compliance'              },
  { id:'priorityAction',             label:'Priority Action'               },
  { id:'cyclingZones',               label:'Cycling Zones'                 },
  { id:'cyclingNpTrend',             label:'Cycling NP Trend'              },
  { id:'swimmingZones',              label:'Swimming Zones'                },
  { id:'swimSwolfTrend',             label:'Swim SWOLF Trend'              },
  { id:'runningCv',                  label:'Running CV'                    },
  { id:'runningRaceReadiness',       label:'Running Race Readiness'        },
  { id:'fitnessBatteryProgress',     label:'Fitness Battery Progress'      },
  { id:'triathlonLoad',              label:'Triathlon Load'                },
  { id:'triathlonWeekBalance',       label:'Triathlon Week Balance'        },
