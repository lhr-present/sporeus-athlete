...
// ─── LactateEstimator sub-component ──────────────────────────────────────────
function LactateEstimator({ lang = 'en' }) {
...
export default function TestProtocols() {
  ...
  const [result, setResult] = useState(null)
  const { testResults: testLog, setTestResults: setTestLog, recovery } = useData()
